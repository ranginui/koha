...
my $sth = $dbh->prepare("select * from biblio,biblioitems where 
  ...
  and (biblioitems.itemtype ='M'
      or biblioitems.itemtype = 'MJ'
      or biblioitems.itemtype = 'MP'
      or biblioitems.itemtype = 'MR'
      or biblioitems.itemtype = 'MY'
      or biblioitems.itemtype = 'PP'
      or biblioitems.itemtype = 'PY'
      or biblioitems.itemtype = 'PYP')
