...
sub search_for_known_scripts : Tests( 2 ) {
    ...
    foreach my $script ( 'installer/data/mysql/en/mandatory/message_transport_types.sql', 'installer/data/mysql/en/optional/sample_notices_message_attributes.sql', ) {
