...
-->
 ...
 <genre authority="marc">catalogue</genre>
 </xsl:when>
 ...
 <digitalOrigin>digitised microfilm</digitalOrigin>
 </xsl:if>
 <xsl:if test="$typeOf008='CF' and marc:controlfield[@tag=007][substring(.,12,1)='d']">
 <digitalOrigin>digitised other analog</digitalOrigin>
 </xsl:if>
 ...
 <targetAudience authority="marctarget">specialised</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
