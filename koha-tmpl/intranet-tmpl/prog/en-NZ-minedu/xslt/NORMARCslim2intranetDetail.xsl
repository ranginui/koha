...
<xsl:stylesheet version="1.0"
 ...
 <xsl:when test="$field019b='a' or contains($field019b,'ab') or contains($field019b,'aj') or $leader6='e' or $leader6='f'">Cart</xsl:when>
 ...
 <xsl:when test="$typeOf008='Kar'"><img alt="Cart" src="/intranet-tmpl/prog/img/famfamfam/MP.png" title="Cart" /> Cart</xsl:when>
 ...
 <span class="results_summary subjects"><span class="label">Emner: </span>
