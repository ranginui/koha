...
$DBversion = "3.08.01.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion (3.8.1 release) done\n";
    SetVersion($DBversion);
}

$DBversion = "3.08.01.001";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
