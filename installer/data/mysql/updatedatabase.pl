...
$DBversion = "3.04.01.000";
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.4.1 release. See release notes for details.)\n";
    SetVersion ($DBversion);
}
...
$DBversion = "3.04.02.000";
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.4.2 release. See release notes for details.)\n";
    SetVersion ($DBversion);
}
