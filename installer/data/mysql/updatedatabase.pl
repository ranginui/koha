...
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    ...
    if ( C4::Context->preference("marcflavour") eq 'UNIMARC' ) {
        ...
        ('auth-form-parrallel','form-parrallel','ste',0,'authority',0,0,'','',''),
        ('auth-form-see','form-see','ste',0,'authority',0,0,'','',''),
        ('auth-form-see-also','form-see-also','ste',0,'authority',0,0,'','',''),
        ('auth-heading','heading','ste',0,'authority',0,1,'','',''),
        ...
        ('auth-name-geographic-parallel','name-geographic-parrallel','ste',0,'authority',0,0,'','',''),
        ...
        ('auth-name-parallel','name-parrallel','ste',0,'authority',0,0,'','',''),
        ...
        ('auth-name-title-parallel','name-title-parrallel','ste',0,'authority',0,0,'','',''),
        ...
        ('auth-parrallel','parrallel','ste',0,'authority',0,0,'','',''),
        ...
        ('auth-personal-name-parrallel','personal-name-parrallel','ste',0,'authority',0,0,'','',''),
        ...
        ('auth-place-parrallel','place-parrallel','ste',0,'authority',0,0,'','',''),
        ...
        ('auth-subject-parrallel','subject-parrallel','ste',0,'authority',0,0,'','',''),
        ...
        ('auth-title-uniform-parallel','title-uniform-parrallel','ste',0,'authority',0,0,'','',''),
