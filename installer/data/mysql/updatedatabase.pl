...
$dbh->do("INSERT IGNORE INTO systempreferences (variable,value,explanation,options,type) VALUES('OpacElectreTdm', '0', 'if ON, enable table of Contents displaying from Electre ws',NULL,'YesNo')");
