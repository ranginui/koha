INSERT INTO permissions (module_bit, code, description) VALUES
   ...
   (13, 'moderate_tags', 'Moderer les signets des lecteurs'),
   ...
   (15, 'check_expiration', 'Vérifier la date de fin d''un abonnement'),
   (15, 'claim_serials', 'Réclamer les périodiques manquants'),
   (15, 'create_subscription', 'Créer un nouvel abonnement'),
   (15, 'delete_subscription', 'Supprimer un abonnement'),
   (15, 'edit_subscription', 'Modifier un abonnement existant'),
   (15, 'receive_serials', 'Réceptionner des périodiques'),
