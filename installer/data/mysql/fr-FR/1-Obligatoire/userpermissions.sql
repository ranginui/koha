...
INSERT INTO permissions (module_bit, code, description) VALUES
    ...
    (15, 'check_expiration', 'Vérifier l''expiration d''un périodique'),
    (15, 'claim_serials', 'Réclamer les périodiques manquants'),
    (15, 'create_subscription', 'Créer un nouvel abonnement'),
    (15, 'delete_subscription', 'Effacer un abonnement'),
    (15, 'edit_subscription', 'Modifier un abonnement'),
    (15, 'receive_serials', 'Réception de périodiques'),
    (15, 'renew_subscription', 'Renouveler un abonnement'),
    (15, 'routing', 'Liste de circulation'),
